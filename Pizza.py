...
#------ page 2------
    def Login(sf):
        ...
        sf.rg=Button(sf.loginf2,text="New to Lovely's Pizza--",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
